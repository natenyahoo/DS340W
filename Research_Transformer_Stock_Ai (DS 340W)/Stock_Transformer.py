...
# from trainer import callback_selector
...
class Transformer(keras.Model):
    def __init__(
            self,
            num_hid, # embed_dim - num of features
            time_steps,
            num_head,
            num_feed_forward, # pointwise dim
            num_layers_enc,
            time_embedding,
    ):
        super().__init__()
...
def fit_transformer_model(model, X, y, epochs, batch_size, callbacks, model_results_path, K = 3, **kwargs):
